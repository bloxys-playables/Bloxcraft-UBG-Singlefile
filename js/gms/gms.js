  ...
  try {
    ...
    DATA.gn = dedupeGames(safeArray(d)
      ...
      .map(g => ({
        ...
        url: "https://raw.githack.com/bloxys-playables/Bloxcraft-UBG-Singlefile/main/html/app-viewer/gn-math/?gn-id=" + g.id
      })));
  } catch (e) {}
}
...
async function loadElite() {
  try {
    ...
    DATA.elite = dedupeGames(safeArray(d).map(g => ({
      ...
      url: "https://raw.githack.com/bloxys-playables/Bloxcraft-UBG-Singlefile/main/html/app-viewer/elite-gamez?url=" + encodeURIComponent(g.url)
    })));
  } catch (e) {}
}
    ...
    DATA.ugs = dedupeGames(extractedFiles
      ...
      .map(f => {
        ...
        return {
          ...
          url: "https://raw.githack.com/bloxys-playables/Bloxcraft-UBG-Singlefile/main/html/app-viewer/ugs-files?view=" + encodeURIComponent(normalizedName)
        };
      })
    );
  } catch (e) {
...
async function loadSeraph() {
  try {
    ...
    DATA.seraph = dedupeGames(safeArray(d).map(g => ({
      name: g.name || "Unknown",
      img: g.img || "",
      url: "https://raw.githack.com/bloxys-playables/Bloxcraft-UBG-Singlefile/main/html/app-viewer/seraph/?view=" + (g.url ? g.url.replace(BASE, "") : "")
    })));
  } catch (e) {}
}
  ...
  try {
    ...
    DATA.ckv = dedupeGames(safeArray(d).map(g => {
      ...
      return {
        ...
        url: "https://raw.githack.com/bloxys-playables/Bloxcraft-UBG-Singlefile/main/html/app-viewer/chicken-kings-vault/?view=" + encodeURIComponent(gameUrl)
      };
    }).filter(Boolean));
  } catch (e) {}
}
...
async function loadHydra() {
  try {
    ...
    DATA.hydra = dedupeGames(rawArray.map(g => {
      ...
      return { name: g.title || g.name || "Unknown", img: thumb, url: "https://raw.githack.com/bloxys-playables/Bloxcraft-UBG-Singlefile/main/html/app-viewer/hydra-network/?view=" + encodeURIComponent(file) };
    }).filter(Boolean));
  } catch (e) {}
}
...
async function loadCCPorted() {
  try {
    ...
    DATA.ccported = dedupeGames(safeArray(d).map(g => {
      ...
      return { name: g.name || g.title || "Game " + id, img: img, url: "https://raw.githack.com/bloxys-playables/Bloxcraft-UBG-Singlefile/main/html/app-viewer/ccported/?view=" + encodeURIComponent(id) };
    }).filter(Boolean));
  } catch (e) {}
}
...
async function loadGoogleClass() {
  try {
    ...
    DATA.googleclass = dedupeGames(safeArray(d).map(g => ({
      name: g.name || "Unknown",
      img: g.img || "",
      url: "https://raw.githack.com/bloxys-playables/Bloxcraft-UBG-Singlefile/main/html/app-viewer/google-class/?view=" + encodeURIComponent(g.url)
    })));
  } catch (e) {}
}
  ...
  try {
    ...
    DATA.truffled = dedupeGames(safeArray(d).map(g => {
      ...
      return {
        ...
        url: "https://raw.githack.com/bloxys-playables/Bloxcraft-UBG-Singlefile/main/html/sail/embed/#https://truffled.lol/" + g.url.replace(/^\/+/, "")
      };
    }).filter(Boolean));
  } catch (e) {}
}
...
async function loadAlexrworlds() {
  try {
    ...
    DATA.alexrworlds = dedupeGames(safeArray(d).map(g => ({
      name: g.title || "Unknown",
      img: g.img || FALLBACK_IMG,
      url: "https://raw.githack.com/bloxys-playables/Bloxcraft-UBG-Singlefile/main/html/app-viewer/alexr-world-s/?view=" + encodeURIComponent(g.title)
    })));
  } catch (e) {}
}
  ...
  try {
    ...
    DATA.lupine = dedupeGames(safeArray(d).map(g => {
      ...
      return {
        ...
        url: "https://raw.githack.com/bloxys-playables/Bloxcraft-UBG-Singlefile/main/html/app-viewer/LupineVault/?view=" + encoded
      };
    }).filter(Boolean));
  } catch (e) {}
}
...
async function load3kh0() {
  try {
    ...
    DATA["3kh0"] = dedupeGames(safeArray(d).map(name => ({
      ...
      url: "https://raw.githack.com/bloxys-playables/Bloxcraft-UBG-Singlefile/main/html/app-viewer/3kh0/?view=" + encodeURIComponent(name)
    })));
  } catch (e) {}
}
...
async function load3kh0Lite() {
  try {
    ...
    DATA["3kh0lite"] = dedupeGames(safeArray(d).map(g => ({
      ...
      url: "https://raw.githack.com/bloxys-playables/Bloxcraft-UBG-Singlefile/main/html/app-viewer/3kh0/lite/?view=" + encodeURIComponent(g.link)
    })));
  } catch (e) {}
}
  ...
  try {
    ...
    DATA.tglsc = dedupeGames(safeArray(d).map(g => {
      ...
      return {
        ...
        url: "https://raw.githack.com/bloxys-playables/Bloxcraft-UBG-Singlefile/main/html/sail/embed/#" + g.embed_url.replace(/^https?:\/\//, "")
      };
    }).filter(Boolean));
  } catch (e) {}
}
  ...
  try {
    ...
    DATA.selenite = dedupeGames(safeArray(d).map(g => {
      ...
      return {
        ...
        url: "https://raw.githack.com/bloxys-playables/Bloxcraft-UBG-Singlefile/main/html/sail/embed/#https://selenite.cc/resources/semag/" + dir + "/index.html"
      };
    }).filter(Boolean));
  } catch (e) {}
}
  ...
  try {
    ...
    DATA.velera = dedupeGames(safeArray(d).map(g => {
      ...
      return {
        ...
        url: "https://raw.githack.com/bloxys-playables/Bloxcraft-UBG-Singlefile/main/html/sail/embed/#https://velara.cc/" + String(g.location || "").replace(/^\/+/, "")
      };
    }).filter(Boolean));
  } catch (e) {}
}
...
async function loadEpicway() {
  try {
    ...
    DATA.epicway = dedupeGames(safeArray(gamesData).map(g => {
      ...
      let finalUrl = "https://raw.githack.com/bloxys-playables/Bloxcraft-UBG-Singlefile/main/html/sail/embed/#https://wilway.today/" + cleanEmbedUrl;
  ...
  try {
    ...
    DATA.noahh = dedupeGames(safeArray(d).map(g => {
      ...
      return {
        ...
        url: url.replace("https://cdn.jsdelivr.net/gh/NoahsAmazingTutoringHelp/Noahs-Calculus-Tutor/", "https://raw.githack.com/bloxys-playables/Bloxcraft-UBG-Singlefile/main/html/app-viewer/noah/?view=")
      };
    }).filter(Boolean));
  } catch (e) {}
}
...
async function loadYoutube() {
  try {
    ...
    DATA.youtube = dedupeGames(safeArray(d).map(g => {
      ...
      return { name: g.name, img: "/youtube.png", url: "https://raw.githack.com/bloxys-playables/Bloxcraft-UBG-Singlefile/main/html/app-viewer/youtube-playables/?view=" + encodeURIComponent(g.name) };
    }).filter(Boolean));
  } catch (e) {}
}
...
async function loadSolo() {
  try {
    ...
    DATA.solo = dedupeGames(safeArray(d).map(g => {
      ...
      let finalUrl = ("https://raw.githack.com/bloxys-playables/Bloxcraft-UBG-Singlefile/main/html/sail/embed/#play.qatual.com/" + (g.url || "")).replace(/([^:]\/)\/+/g, "$1");
...
async function loadDegloved() {
  try {
    const r = await fetch("https://cdn.jsdelivr.net/gh/tharun9772/Bloxcraft-UBG@main/games/data/json/degloved.json");
    if (!r.ok) return;
    const d = await r.json();
    DATA.degloveed = dedupeGames(safeArray(d).map(g => {
      ...
      return {
        ...
        url: "https://raw.githack.com/bloxys-playables/Bloxcraft-UBG-Singlefile/main/html/sail/embed/#" + g.url
      };
    }).filter(Boolean));
  } catch (e) {}
}
...
async function loadKruated() {
  try {
    const r = await fetch("https://cdn.jsdelivr.net/gh/tharun9772/Bloxcraft-UBG@main/games/data/json/kruated.json");
    if (!r.ok) return;
    const d = await r.json();
...
async function loadPizzalite() {
  try {
    const r = await fetch("https://cdn.jsdelivr.net/gh/tharun9772/Bloxcraft-UBG@main/games/data/json/petezah.json");
    if (!r.ok) return;
    const d = await r.json();
...
async function loadMaz() {
  try {
    const r = await fetch("https://cdn.jsdelivr.net/gh/tharun9772/Bloxcraft-UBG@main/games/data/json/the-marz-lib.json");
    if (!r.ok) return;
    const d = await r.json();
    DATA.maz = dedupeGames(safeArray(d).map(g => {
      ...
      return {
        ...
        url: "https://raw.githack.com/bloxys-playables/Bloxcraft-UBG-Singlefile/main/html/sail/embed/#https://themarzlibrary.org" + g.url
      };
    }).filter(Boolean));
  } catch (e) {}
}
...
async function loadShuttleProxy() {
  try {
    const r = await fetch("https://cdn.jsdelivr.net/gh/tharun9772/Bloxcraft-UBG@main/games/data/json/shuttleproxy.json");
    if (!r.ok) return;
    const d = await r.json();
    DATA.shuttleproxy = dedupeGames(safeArray(d).map(g => {
      ...
      return {
        ...
        url: "https://raw.githack.com/bloxys-playables/Bloxcraft-UBG-Singlefile/main/html/sail/embed/#https://assets.shuttlemath.com/" + g.root
      };
    }).filter(Boolean));
  } catch (e) {}
}
...
document.addEventListener("DOMContentLoaded", async () => {
  try {
    const res = await fetch("https://cdn.jsdelivr.net/gh/tharun9772/Bloxcraft-UBG@main/games/topics.json");
