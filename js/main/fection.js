...
<div id="loader">
  <div class="loader-content">
     <img src="img/bloxcraft_transparent.png" style="width: 200px; height: 200px;">
    <p>&nbsp;</p>
...
<div class="app">
  ...
  <div class="main">
    <div class="home" id="home">
      <div class="logo">
        <img src="img/bloxcraft_transparent.png" alt="Bloxcraft UBG | Logo">
      </div>
      ...
      <div class="subtitle">v.4.26.7.21 <span id="checkversion">(Loading JSON API...)</span></div>
