(function() {
    ...
    const originalFavicon = originalFaviconLink?.href || "bloxcraft_transparent.png"; 
    ...
    document.addEventListener("visibilitychange", () => {
        ...
        if (document.hidden) {
            ...
            let awayFavicon = "https://cdn.jsdelivr.net/gh/tharun9772/bloxcraft-ubg@main/idle-favicons/clasroom.ico"; 
            let awayType = blank;

            if (config.preset === "drive") {
                awayTitle = "Home - Google Drive";
                awayFavicon = "https://cdn.jsdelivr.net/gh/tharun9772/bloxcraft-ubg@main/idle-favicons/drive.png";
                awayType = png;
            } else if (config.preset === "docs") {
                awayTitle = "Google Docs";
                awayFavicon = "https://cdn.jsdelivr.net/gh/tharun9772/bloxcraft-ubg@main/idle-favicons/docs.ico";
                awayType = blank;
    ...
    menu.innerHTML = `
        <div class="close-btn" id="close-menu">âœ•</div>
